        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentificationCiphertext = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedAnswerHash = table.Column<string>(type: "text", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClaimQuestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClaimQuestions_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnswerCiphertext = table.Column<string>(type: "text", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exchanges_Claims_ClaimId",
                        column: x => x.ClaimId,
                        principalTable: "Claims",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Ratings_Exchanges_ExchangeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditEvents_EntityType_EntityId_CreatedAtUtc",
                table: "AuditEvents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClaimAnswers_ClaimId_QuestionId",
                table: "ClaimAnswers",
                columns: new[] { "ClaimId", "QuestionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClaimAnswers_QuestionId",
                table: "ClaimAnswers",
                column: "QuestionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemAttributes_ItemId_Key",
                table: "ItemAttributes",
                columns: new[] { "ItemId", "Key" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemMatches_LostItemId_FoundItemId",
                table: "ItemMatches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_Type_Status_CreatedAtUtc",
                table: "Items",
                columns: new[] { "Type", "Status", "CreatedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QrTokens_ItemId",
                table: "QrTokens",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_QrTokens_PublicTokenHash",
                table: "QrTokens",
                column: "PublicTokenHash",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Ratings_ExchangeId_ReviewerId_RevieweeId",
                table: "Ratings",
                columns: new[] { "ExchangeId", "ReviewerId", "RevieweeId" },
                unique: true);
